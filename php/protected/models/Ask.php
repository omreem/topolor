...
Yii::import('application.models._base.BaseAsk');
...
class Ask extends BaseAsk
{
	...
	public function getTagLinks() {
		...
		foreach(Tag::string2array($this->tags) as $tag)
			$links[]=CHtml::link(CHtml::encode($tag), array('ask/index', 'tag'=>$tag), array('class'=>'label label-info tag selected'));
		return $links;
	}
	...
	protected function afterSave() {
		parent::afterSave();
		Tag::model()->updateFrequency($this->_oldTags, $this->tags, 'ask');
	}
	...
	protected function afterDelete() {
		...
		Favorite::model()->deleteAll('of=:of and of_id=:of_id', array(':of'=>'ask', ':of_id'=>$this->id));
	}
