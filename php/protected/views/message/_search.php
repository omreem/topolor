...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'to_message_id'); ?>
		<?php echo $form->dropDownList($model, 'to_message_id', GxHtml::listDataEx(Message::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
